...
pytest test_frag2.py --html=report1.html
pytest test_frag_index_2.py --html=report1.html

Note: Only 2 question done 
'''
...
############################################## Question 1
        ...
        QPFrag1.click()
        QPFrag1.send_keys(stream_data_list_Individual_Questions[0]['Marks1'])#stream_data_list_Individual_Questions[0]['Marks1']
        time.sleep(5)
        print("Mark.....")

        QPFrag2 = self.driver.find_element(By.NAME, 'questions.0.qdisplay')
        QPFrag2.click()
        QPFrag2.send_keys(stream_data_list_Individual_Questions[0]['QuestionNumber2'])#stream_data_list_Individual_Questions[0]['QuestionNumber2']
        time.sleep(5)
        ...
        QPFrag3.click()
        QPFrag3.send_keys(stream_data_list_Individual_Questions[0]['QuestionsIndividual3'])
        time.sleep(4)
        print("Question .......")
...
########################################################### Question 2
        ...
        QPFrag12.click()
        QPFrag12.send_keys(stream_data_list_Individual_Questions[1]['Marks1'])
        time.sleep(5)
        print("Mark.....")

        QPFrag2 = self.driver.find_element(By.NAME, 'questions.1.qdisplay')
        QPFrag2.click()
        QPFrag2.send_keys(stream_data_list_Individual_Questions[1]['QuestionNumber2'])
        time.sleep(5)
        print("Question Number.......")
        ...
        QPFrag3.click()
        QPFrag3.send_keys(stream_data_list_Individual_Questions[1]['QuestionsIndividual3'])
        time.sleep(4)
        print("Question .......")
######################################################################
########################################################### Question 3
