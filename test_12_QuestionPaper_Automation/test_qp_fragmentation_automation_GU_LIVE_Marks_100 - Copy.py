...
pytest test_qp_fragmentation_automation_GU_LIVE_Marks_100.py --html=report1.html

CSV:
fragDropdownMark100.csv
fragNumberOfQuestionsMark100.csv
fragIndividualQuestionsMarks100.csv
...
##############################################################################
    ...
    def test_login(self):
        ...
        #self.driver.get("http://172.25.8.162") # application user for testing   https://gung.intelliexams.com/auth/login
...
# Login Conformation Pop UP disable
...
########################################################################################################################
    def test_QP_Frag_Dropdown_Field_Selection_1(self):
        ...
        stream_data_list = self.read_stream_data('fragDropdownMarks100.csv')
        ...
        for stream_data in stream_data_list:
            ...
            stream_menu2 = self.driver.find_element(By.XPATH, '/html/body/div[1]/div[2]/div[1]/nav/div[2]/ul/div/div[1]/div[2]/div/div/div/li[4]/ul/li[2]/a/span')
            stream_menu2.click()
            time.sleep(2)
            ...
            # 3 Subject Code Text box field entered 
            ...
            # Start Processing QP Button click  -> 2.Details link click
...
###################################################################### QuestionNumbe NumberOfQuestions
    ...
    def test_QP_Frag_QuestionNumber_NoofQuestion_Field_Entry_2(self):
        ...
        self.read_credentials_NumberOfQuestion('fragNumberOfQuestionsMarks100.csv')
        time.sleep(1)
...
################################################################################################### Marks1     QuestionNumber2   QuestionsIndividual3
    ...
    def test_QP_Frag_Individual_Questions3(self):
        stream_data_list_Individual_Questions = self.read_stream_data_Individual_Questions('fragIndividualQuestionsMarks100.csv')
    ...
    def test_Create_Button(self):
        ...
        #/html/body/div[1]/div[2]/div[2]/div[2]/div/div/div/div[2]/form/div[2]/div/div/div/div/button
        #/html/body/div[1]/div[2]/div[2]/div[2]/div/div/div/div[2]/form/div[11]/div/div/div/div/button
        QPFrag_Create_Button1 = self.driver.find_element(By.XPATH, '/html/body/div[1]/div[2]/div[2]/div[2]/div/div/div/div[2]/form/div[11]/div/div/div/div/button')
